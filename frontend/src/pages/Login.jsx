...
export default function Login({ onLogin }) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Pindahkan kembali ke form login setelah 3 detik
      setTimeout(() => {
        setIsRegister(false);
        setSuccess('');
      }, 3500);
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-xl text-gray-400 hover:text-orange-500 focus:outline-none select-none"
                >
                  {showPassword ? '👁️‍?/span>' : '👁️'}
                </button>
              </div>
            </div>
